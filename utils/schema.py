...
COLUMN_ALIASES = {
    "date": ["date", "order date", "transaction date", "sale date", "order_date", "trans_date", "day", "invoice date"],
    "sales": ["sales", "revenue", "amount", "total", "total sales", "sale amount", "sales amount", "gross sales", "net sales", "price"],
    "store_id": ["store_id", "store", "store number", "store no", "branch", "branch_id", "location", "location_id", "shop", "shop_id"],
    "product_id": ["product_id", "item", "item_id", "sku", "product sku", "product_code", "upc"],
    "product_name": ["product_name", "product", "item", "item name", "item_name", "description", "product description", "item description", "name"],
    "category": ["category", "department", "dept", "product category", "product_category", "type", "segment"],
    "quantity": ["quantity", "qty", "units", "units sold", "units_sold", "quantity sold", "count"],
